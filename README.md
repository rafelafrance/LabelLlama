...
I run a local model to OCR images. I use the LM-Studio daemon for this.
...
- --doc-in demo/ocr_demo_docs.csv The output from the OCR script.
...
LLM extracted the "northing", "easting", and "zone" then the local model is skipped for
that particular "UTM".
