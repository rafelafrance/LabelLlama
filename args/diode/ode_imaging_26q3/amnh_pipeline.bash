...
uv run ./llama/ocr_images.py \
  ...
  --model-id gemma-4-E4B-it-UD-Q8_K_XL \
...
uv run llama/parse_text.py \
    ...
    --model-id Qwen3.6-35B-A3B-UD-Q8_K_XL \
    --api-host "http://localhost:9931/v1" \
    --temperature 0.1 \
    --timeout 300 \
    --threads 4 \
...
#     --image-glob "$data_dir"/"images/DiODE-20260827T160325Z-*/*/**/*" \
#     --parsed-file "$data_dir"/parse_images_"$stamp"a.csv \
#     --prompt prompts/diode_one_v1.md \
#     --model-id  Qwen3.8-27B-UD-Q8_K_XL \
#     --api-host http://localhost:9931/v1 \
#     --temperature 0.1 \
#     --max-tokens 4096 \
#     --timeout 300 \
#     --threads 4 \
#     --limit 100 \
#     --log-file "$data_dir"/parse_images.log
