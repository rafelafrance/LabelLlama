...
class InsectLabel(Signature):
    ...
    occurrence_id: str = OutputField(desc=occurrence_id.OCCURRENCE_ID)
    ...
    water_body: str = OutputField(desc=water_body.WATER_BODY)
    island: str = OutputField(desc=island.ISLAND)
    island_group: str = OutputField(desc=island_group.ISLAND_GROUP)
