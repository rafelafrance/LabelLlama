...
class HerbariumSheet(Signature):
    ...
    scientificName: str = OutputField(
        default="",
        desc="""Scientific name or species given in 'Genus species' format.
    ...
    recordNumber: str = OutputField(
        default="",
        desc="""The number used to identify the collector or who recorded the specimen.
            The record number is almost always found just after or before the
            collector's name or event date. Key to this is noticing the association.
            """,
    )
    ...
    trs: str = OutputField(
        default="",
        desc="""Township Range Section (TRS).
    ...
    trsTownship: str = OutputField(
        default="",
        desc="""The township portion of the TRS. It will look like: "T28N" or "T 32 N".
    ...
    trsRange: str = OutputField(
        default="",
        desc="""The range portion of the TRS. It will look like: "R23E" or "R 1 W".
    ...
    trsSection: str = OutputField(
        default="",
        desc="""The section portion of the TRS. Examples look like "1/4 S10",
    ...
    trsQuad: str = OutputField(
        default="",
        desc="""The quad (quadrangle) portion of the TRS. It may be at the beginning or
    ...
    utm: str = OutputField(
        default="",
        desc="""Universal Transverse Mercator (UTM)
    ...
    utmNorthing: str = OutputField(
        default="",
        desc="""The northing portion of the UTM.
    ...
    utmEasting: str = OutputField(
        default="",
        desc="""The easting portion of the UTM.
    ...
    utmZone: str = OutputField(
        default="",
        desc="""The zone portion of the UTM. It will look like: "10S", "11", "8N",
            "Zone 11S;", "NH", "16P", "LJ".
            """,
    )
    ...
    habit: str = OutputField(
        default="",
        desc="""What is the specimen habit?
            Examples: "herbaceous", "woody", "decumbent", "erect".
            """,
    )
    abundance: str = OutputField(
        default="",
        desc="""How common is the specimen? Examples include "common", "scattered",
            "rare."
            """,
    )
    leafShape: str = OutputField(
        default="",
        desc="""What is the shape of the specimen's leaf?
            Examples: "acute", "caudate", "elliptic", "lobed"
            """,
    )
    leafMargin: str = OutputField(
        default="",
        desc="""Description of the specimen's leaf margins.
    ...
    occurrenceRemarks: list[str] = OutputField(
        ...
        desc="""This contains all other observations not in the other fields.
            Do not include information from any of the other fields, this is
            strictly for data that is not covered anywhere else.
            """,
    )
