...
COUNTRY_CSV: Path = Path(__file__).parent.parent / "terms" / "countries.csv"
USA_CSV: Path = Path(__file__).parent.parent / "terms" / "us_locations.csv"
CA_CSV: Path = Path(__file__).parent.parent / "terms" / "ca_provinces.csv"
...
US_COUNTY = {
    r["pattern"].lower(): r["pattern"].title() for r in USA_ROWS
