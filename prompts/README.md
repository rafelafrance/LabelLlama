...
I use these Markdown files to generate prompts for various tasks. None of these Markdown files are designed to stand on their own. They are all modified in some way before being sent to the LLM. See [prompt_util.py](../llama/pylib/prompt_util.py).
